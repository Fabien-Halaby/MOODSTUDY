          ...
          <div class="large-banner">
            <table>
                <thead>
                        ...
                        <td class="td">Matières</td>
                        <td class="td">Coéfficient</td>
                        <td class="td">Connaissances</td>
                        <td class="td">Supprimer</td>
                    
                </thead>
                <div>
                    <?php
                        $req = mysqli_query($database->conn,"SELECT * FROM `Matieres` WHERE email = '$email'");
                        if(mysqli_num_rows($req) == 0){
                            echo "Pas de matière en cours.";
                        }else{
                            while($row = mysqli_fetch_assoc($req)){
                                ?>
                                    <tr class="tr">
                                        <td class="td"><?=$row['matiere']?></td>
                                        <td class="td"><?=$row['coefficient']?></td>
                                        <td class="td"><?=$row['connaissance']?></td>
